...
function checkWinner(){
    setTimeout(() => {
        ...
        else {updateHpInBlock(undefined, playerCreaturesAtTheEndOfBattle, game.playerHero);game.battle = false; }
        game.update();
...
class Game{
    ...
    createBattle(playerCoinsBeforeBattle){
            ...
            while(enemyBattleCreatureA.hp > 0 && playerBattleCreatureA.hp > 0){
                if(playerBattleCreatureA.unique.includes(Unics.Divine_Shield)){
                    for(let i = 0; i < playerBattleCreatureA.unique.length; i++){
                        if (playerBattleCreatureA.unique[i] === Unics.Divine_Shield && playerBattleCreatureA.Creatureblock.childNodes[5]){
                            ...
                            playerBattleCreatureA.Creatureblock.removeChild(playerBattleCreatureA.Creatureblock.childNodes[5])
                        }                    
                    }    
                }
                else if(enemyBattleCreatureA.unique.includes(Unics.Divine_Shield)){
                    for(let i = 0; i < enemyBattleCreatureA.unique.length; i++){
                        if (enemyBattleCreatureA.unique[i] === Unics.Divine_Shield && enemyBattleCreatureA.Creatureblock.childNodes[5]){
                            ...
                            enemyBattleCreatureA.Creatureblock.removeChild(enemyBattleCreatureA.Creatureblock.childNodes[5])
                        }                    
                    }    
                }
